...
export declare namespace TelegramWebApps {
  ...
  interface WebApp {
     ...
     * A method that deletes a previously set event handler.
     */
    offEvent(eventType: 'viewportChanged', eventHandler: ViewportChangedEventHandler): void
    /**
     * A method that deletes a previously set event handler.
     */
  ...
  interface CloudStorage {
    ...
    removeItems(
      keys: string[],
      callback?: ((error: Error) => void) | ((error: null, valuesRemoved: boolean) => void),
    ): CloudStorage
    /**
  ...
  interface BiometricManager {
     ...
     */
    updateBiometricToken(token: string, callback?: (tokenPassed: boolean) => void): BiometricManager
    /**
